...
class AddPrinter : BaseFragment() {
    ...
    override fun initView(view: View?, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            EpsonUtils.showException(e, "start", context!!)
        }
    ...
    private fun initToolbar() {
        ...
        img_toolbar_back.setOnClickListener {
            log(OrderDetails.TAG, "back press:")
    ...
    override fun handleBackButton(): Boolean {
        (parentFragment as SettingInfoFragment).pop()
        return true
    ...
    private fun restartDiscovery() {
        while (true) {
            try {
                ...
                if (e.errorStatus != Epos2Exception.ERR_PROCESSING) {
                    EpsonUtils.showException(e, "stop", context!!)
                    return
                }
            }
        }
